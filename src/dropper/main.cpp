...
//			cv::Size(image.cols*cropx*scalex, image.rows*cropy*scaley));
		...
		{
			{
				{ -5.30273104,  4.04895163,  8.42346573},
				{   1.85798264,  0.53525203, -3.09870696},
				{  -0.67844105,  0.34725609,  0.88906294},
				{   -2.8503747 ,  2.05657268,  4.96872425},
			},
			{
				{0.08913357},
				{-0.35431015},
			...
			{{-8.63400555,  5.44782162,  0.44984987, -3.76290631},},
			{{4.82254124}},
		});
